...
<script>
    ...
    export default defineComponent({
        setup() {
            ...
            const searchFormOptions = ref([[{"title":"商户名称","field":"OwnerName"},{"title":"付款日期","field":"PaymentDate","type":"date"},{"title":"租赁起始日期","field":"RentalStartTime","type":"date"},{"title":"租赁结束日期","field":"RentalEndTime","type":"date"}]]);

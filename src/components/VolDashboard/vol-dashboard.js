...
const base = {
  getDate: function(e) {
    let A = /* @__PURE__ */ new Date(), l = A.getFullYear(), a = A.getMonth() + 1, n = A.getDate(), g = l + "-" + (a < 10 ? "0" + a : a) + "-" + (n < 10 ? "0" + n : n);
    if (!e)
      return g;
    let s = A.getHours(), t = A.getMinutes(), B = A.getSeconds();
    return g + " " + (s < 10 ? "0" + s : s) + ":" + (t < 10 ? "0" + t : t) + ":" + (B < 10 ? "0" + B : B);
  },
  addDays: function(e, A) {
    ...
    n < 10 && (n = "0" + n);
    var g = e.getDate();
    return g < 10 && (g = "0" + g), e = a + "-" + n + "-" + g, l.length == 1 ? e : e + " " + l[1];
  }
...
function init$2(e, A) {
  ...
  if (l.title.text = e.title, !A || !Array.isArray(A) || A.length == 0)
    return l;
  const a = series();
  let n = Object.keys(A[0]), g = [], s = [];
  s = new Array(n.length - 1).fill({}).map((B, r) => {
    let C = a[r];
    return C ? (C.name = n[r + 1], C.label.show = !!e.showLabel, C.showSymbol = !!e.showLabel, C.stack = e.stack ? "total" : "", e.stack ? (C.type = "bar", C.itemStyle.borderRadius = [0]) : C.itemStyle.borderRadius = [e.radius], C) : {
      name: "名称",
      type: "line",
      smooth: !0,
      lineStyle: {
  ...
  for (let B = 0; B < A.length; B++) {
    ...
    for (let C = 1; C < n.length; C++) {
      let c = s[C - 1];
      c.data.push(r[n[C]]), c.name = n[C];
    }
  }
  return s.forEach((B) => {
    B.barMaxWidth = e.barMaxWidth;
  }), l.series = s, e.showXData ? (l.xAxis.data = g, l.xAxis.type = "category", l.yAxis.data = null) : (l.xAxis.data = null, l.xAxis.type = null, l.yAxis.type = "", l.yAxis.data = g), initLegend(l, A, e, t), l;
}
...
function _sfc_render$1(e, A, l, a, n, g) {
...
const VolHeader = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["render", _sfc_render$1], ["__scopeId", "data-v-dac9b261"]]), __vite_glob_0_0$1 = "data:image/png;base64,", __vite_glob_0_1$1 = "data:image/png;base64,", __vite_glob_0_2$1 = "data:image/png;base64,", __vite_glob_0_3$1 = "data:image/png;base64,", __vite_glob_0_4$1 = "data:image/png;base64,", __vite_glob_0_5$1 = "data:image/png;base64,", __vite_glob_0_6$1 = "data:image/png;base64,", __vite_glob_0_7$1 = "data:image/png;base64,", __vite_glob_0_8$1 = "data:image/png;base64,", __vite_glob_0_9$1 = "data:image/png;base64,", __vite_glob_0_10$1 = "data:image/png;base64,", __vite_glob_0_11$1 = "data:image/png;base64,", __vite_glob_0_12$1 = "data:image/png;base64,", __vite_glob_0_13$1 = "data:image/png;base64,", __vite_glob_0_14$1 = "data:image/png;base64,", __vite_glob_0_15$1 = "data:image/png;base64,", __vite_glob_0_16$1 = "data:image/png;base64,", _hoisted_1$c = { class: "com-list" }, _hoisted_2$b = { class: "com-item-name" }, _hoisted_3$b = ["src"], _sfc_main$c = {
  ...
  setup(e, { emit: A }) {
    ...
    const l = (r) => new URL((/* @__PURE__ */ Object.assign({ "./imgs/bar.png": __vite_glob_0_0$1, "./imgs/calendar.png": __vite_glob_0_1$1, "./imgs/card.png": __vite_glob_0_2$1, "./imgs/form.png": __vite_glob_0_3$1, "./imgs/gauge.png": __vite_glob_0_4$1, "./imgs/grid01.png": __vite_glob_0_5$1, "./imgs/grid02.png": __vite_glob_0_6$1, "./imgs/grid03.png": __vite_glob_0_7$1, "./imgs/grid04.png": __vite_glob_0_8$1, "./imgs/grid05.png": __vite_glob_0_9$1, "./imgs/line.png": __vite_glob_0_10$1, "./imgs/notice.png": __vite_glob_0_11$1, "./imgs/pie1.png": __vite_glob_0_12$1, "./imgs/rankinglist02.png": __vite_glob_0_13$1, "./imgs/rankinglist03.png": __vite_glob_0_14$1, "./imgs/step.png": __vite_glob_0_15$1, "./imgs/table.png": __vite_glob_0_16$1 }))[`./imgs/${r}`], import.meta.url).href, a = ref([
      ...
      a.value = [...n], t("end", a.value[r.oldIndex]);
    };
    return (r, C) => (openBlock(), createElementBlock("div", _hoisted_1$c, [
      createVNode(unref(VueDraggableNext), {
        ...
        default: withCtx(() => [
          (openBlock(!0), createElementBlock(Fragment, null, renderList(a.value, (c, Q) => (openBlock(), createElementBlock("li", {
            key: Q,
            class: "com-item"
          }, [
...
}, VolComponent = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["__scopeId", "data-v-856678bb"]]), _sfc_main$b = {
  props: {
    icon: {
      type: String,
      default: ""
...
function _sfc_render(e, A, l, a, n, g) {
...
const VolTitle = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["render", _sfc_render], ["__scopeId", "data-v-eac0b45f"]]), _hoisted_1$a = { class: "vol-data-table" }, _hoisted_2$9 = { class: "vol-da-table" }, _hoisted_3$9 = {
  ...
  setup(e) {
    ...
    return (a, n) => {
      const g = resolveComponent("el-scrollbar");
      return openBlock(), createElementBlock("div", _hoisted_1$a, [
        createVNode(VolTitle, {
          icon: "el-icon-menu",
          title: a.$ts(e.title)
        }, null, 8, ["title"]),
        createVNode(g, { style: { flex: "1", height: "0", padding: "0 10px" } }, {
          default: withCtx(() => [
            createElementVNode("table", _hoisted_2$9, [
              createElementVNode("thead", null, [
                e.index ? (openBlock(), createElementBlock("td", _hoisted_3$9, "#")) : createCommentVNode("", !0),
                (openBlock(!0), createElementBlock(Fragment, null, renderList(l.value, (s, t) => (openBlock(), createElementBlock("td", { key: t }, toDisplayString(a.$ts(s)), 1))), 128))
              ]),
              (openBlock(!0), createElementBlock(Fragment, null, renderList(e.data, (s, t) => (openBlock(), createElementBlock("tr", { key: t }, [
                e.index ? (openBlock(), createElementBlock("td", _hoisted_4$7, toDisplayString(t + 1) + ".", 1)) : createCommentVNode("", !0),
                (openBlock(!0), createElementBlock(Fragment, null, renderList(l.value, (B, r) => (openBlock(), createElementBlock("td", { key: r }, toDisplayString(a.$ts(s[B])), 1))), 128))
              ]))), 128))
            ])
          ]),
          _: 1
  ...
  setup(e) {
    return getCurrentInstance(), (A, l) => {
      const a = resolveComponent("el-progress"), n = resolveComponent("el-descriptions-item"), g = resolveComponent("el-descriptions"), s = resolveComponent("el-scrollbar");
      return openBlock(), createElementBlock("div", {
        ...
        createVNode(s, { style: { flex: "1", height: "0", padding: "0 10px" } }, {
          default: withCtx(() => [
            createVNode(g, {
              class: "desc-top",
              column: e.column,
              ...
              default: withCtx(() => [
                (openBlock(!0), createElementBlock(Fragment, null, renderList(e.form, (t, B) => (openBlock(), createBlock(n, {
                  key: B,
                  "min-width": 60,
                  "label-align": "left",
                  span: t.span,
        ...
        createVNode(a, { style: { flex: "1", height: "1" } }, {
          default: withCtx(() => [
            createElementVNode("div", _hoisted_3$7, [
              (openBlock(!0), createElementBlock(Fragment, null, renderList(e.data, (n, g) => (openBlock(), createElementBlock("div", {
  ...
  setup(e) {
    return getCurrentInstance(), (A, l) => {
      const a = resolveComponent("el-progress"), n = resolveComponent("el-scrollbar");
      return openBlock(), createElementBlock("div", _hoisted_1$7, [
        createVNode(VolTitle, {
          icon: "el-icon-menu",
          title: e.title
        }, null, 8, ["title"]),
        createVNode(n, { style: { flex: "1", height: "0" } }, {
          default: withCtx(() => [
            createElementVNode("div", {
              class: normalizeClass({ "ranking-top": e.lalelPosition == "top" })
            }, [
              (openBlock(!0), createElementBlock(Fragment, null, renderList(e.data, (g, s) => (openBlock(), createElementBlock("div", {
                class: "fx",
                key: s
              }, [
                createElementVNode("div", _hoisted_2$6, toDisplayString(g.name), 1),
                createElementVNode("div", _hoisted_3$6, [
                  createVNode(a, {
                    "stroke-width": e.strokeWidth,
                    "text-inside": !1,
                    percentage: g.value,
                    color: g.bgColor || e.titleColor[s]
                  }, {
                    default: withCtx(() => [
                      createElementVNode("span", {
                        class: "rk-txt",
                        style: normalizeStyle({ color: g.fontColor || e.fontColor[s] })
                      }, toDisplayString(g.value) + toDisplayString(e.unit), 5)
                    ]),
                    _: 2
...
}, VolDataRanking = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-2d015053"]]), _hoisted_1$6 = { class: "fx-ranking" }, _hoisted_2$5 = { class: "h-bottom margin-item" }, _hoisted_3$5 = { class: "title" }, _hoisted_4$5 = ["onClick"], _hoisted_5$5 = { class: "h-bottom-txt" }, _hoisted_6$4 = { class: "h-bottom-qty" }, _sfc_main$6 = {
  __name: "VolDataGrid",
  props: {
    title: {
      type: String,
  ...
  setup(e, { emit: A }) {
    getCurrentInstance();
    const l = e, a = A, n = (g, s) => {
      a("componentItemClick", g, l.data);
    };
    return (g, s) => (openBlock(), createElementBlock("div", _hoisted_1$6, [
      createElementVNode("div", _hoisted_2$5, [
        createElementVNode("div", _hoisted_3$5, toDisplayString(g.$ts(e.title)), 1),
        createElementVNode("div", {
          class: "grid-list",
          ...
          (openBlock(!0), createElementBlock(Fragment, null, renderList(e.data, (t, B) => (openBlock(), createElementBlock("div", {
            class: normalizeClass(["item", "item" + (B + 1)]),
            key: B,
            onClick: (r) => n(t)
          }, [
      ...
      (openBlock(!0), createElementBlock(Fragment, null, renderList(e.data, (B, r) => (openBlock(), createElementBlock("div", {
        ...
        createElementVNode("div", _hoisted_3$4, [
          createElementVNode("div", _hoisted_4$4, [
            ...
            }, toDisplayString(B.name || B.title), 5),
            createElementVNode("div", {
              class: "vol-grid-item-value",
              style: normalizeStyle({ color: e.fontColor || "#505050" })
            }, toDisplayString(((B.value || 0) + "").replace(/\B(?=(\d{3})+(?!\d))/g, ",")), 5),
  ...
  setup(e) {
    ...
    a.value = new Array(35).fill(0).map((t, B) => ({
      img: new URL((/* @__PURE__ */ Object.assign({ "./icon/1.png": __vite_glob_0_0, "./icon/10.png": __vite_glob_0_1, "./icon/11.png": __vite_glob_0_2, "./icon/12.png": __vite_glob_0_3, "./icon/13.png": __vite_glob_0_4, "./icon/14.png": __vite_glob_0_5, "./icon/15.png": __vite_glob_0_6, "./icon/16.png": __vite_glob_0_7, "./icon/17.png": __vite_glob_0_8, "./icon/18.png": __vite_glob_0_9, "./icon/19.png": __vite_glob_0_10, "./icon/2.png": __vite_glob_0_11, "./icon/20.png": __vite_glob_0_12, "./icon/21.png": __vite_glob_0_13, "./icon/22.png": __vite_glob_0_14, "./icon/23.png": __vite_glob_0_15, "./icon/24.png": __vite_glob_0_16, "./icon/25.png": __vite_glob_0_17, "./icon/26.png": __vite_glob_0_18, "./icon/27.png": __vite_glob_0_19, "./icon/28.png": __vite_glob_0_20, "./icon/29.png": __vite_glob_0_21, "./icon/3.png": __vite_glob_0_22, "./icon/30.png": __vite_glob_0_23, "./icon/31.png": __vite_glob_0_24, "./icon/32.png": __vite_glob_0_25, "./icon/33.png": __vite_glob_0_26, "./icon/34.png": __vite_glob_0_27, "./icon/35.png": __vite_glob_0_28, "./icon/4.png": __vite_glob_0_29, "./icon/5.png": __vite_glob_0_30, "./icon/6.png": __vite_glob_0_31, "./icon/7.png": __vite_glob_0_32, "./icon/8.png": __vite_glob_0_33, "./icon/9.png": __vite_glob_0_34 }))[`./icon/${B + 1}.png`], import.meta.url).href,
      //   img: new URL("./icon/" + (i + 1) + ".png", import.meta.url),
      name: B + 1 + ".png"
    }));
    const n = ref(-1), g = (t, B) => {
      n.value = B;
      let r = A.data.indexOf(t);
      r == -1 ? A.data.push(t) : A.data.splice(r, 1);
    }, s = (t) => A.data.indexOf(t) > -1;
    return (t, B) => (openBlock(), createElementBlock("div", _hoisted_1$4, [
      (openBlock(!0), createElementBlock(Fragment, null, renderList(unref(l), (r, C) => withDirectives((openBlock(), createElementBlock("div", {
        onClick: (c) => g(r, C),
        key: C,
        class: "icons-item"
      }, [
        createElementVNode("i", {
          class: normalizeClass([r, s(r) ? "active" : ""]),
          style: { "font-size": "32px" }
        }, null, 2),
        createElementVNode("p", null, toDisplayString(r), 1)
      ], 8, _hoisted_2$3)), [
        [vShow, e.font]
      ])), 128)),
      withDirectives(createElementVNode("div", _hoisted_3$3, [
        (openBlock(!0), createElementBlock(Fragment, null, renderList(a.value, (r, C) => (openBlock(), createElementBlock("div", {
          class: normalizeClass(["icon-item", [r, s(r.name) ? "active-img" : ""]]),
          onClick: (c) => g(r.name, C),
          key: C
        }, [
          createElementVNode("img", {
            src: r.img
  ...
  class: "img-icon",
  style: { display: "flex" }
}, _hoisted_23 = ["onClick"], _hoisted_24 = {
  class: "img-icon",
  style: { display: "flex" }
}, _hoisted_25 = ["onClick"], _hoisted_26 = {
  class: "img-icon",
  style: { display: "flex" }
}, _hoisted_27 = ["onClick"], _hoisted_28 = { class: "params-group" }, _hoisted_29 = { class: "params-group" }, _hoisted_30 = { class: "params-group" }, _hoisted_31 = { class: "params-group" }, _hoisted_32 = { class: "custom-tabs-label" }, _hoisted_33 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createElementVNode("span", null, "事件处理", -1)), _sfc_main$3 = {
  ...
  setup(e, { emit: A }) {
    const l = e, a = ref("基础设置"), n = filter, g = [
      { value: "-1", name: "隐藏图例" },
      { value: "left", name: "靠左" },
    ...
    }, J = (k) => new URL((/* @__PURE__ */ Object.assign({ "./icon/1.png": __vite_glob_0_0, "./icon/10.png": __vite_glob_0_1, "./icon/11.png": __vite_glob_0_2, "./icon/12.png": __vite_glob_0_3, "./icon/13.png": __vite_glob_0_4, "./icon/14.png": __vite_glob_0_5, "./icon/15.png": __vite_glob_0_6, "./icon/16.png": __vite_glob_0_7, "./icon/17.png": __vite_glob_0_8, "./icon/18.png": __vite_glob_0_9, "./icon/19.png": __vite_glob_0_10, "./icon/2.png": __vite_glob_0_11, "./icon/20.png": __vite_glob_0_12, "./icon/21.png": __vite_glob_0_13, "./icon/22.png": __vite_glob_0_14, "./icon/23.png": __vite_glob_0_15, "./icon/24.png": __vite_glob_0_16, "./icon/25.png": __vite_glob_0_17, "./icon/26.png": __vite_glob_0_18, "./icon/27.png": __vite_glob_0_19, "./icon/28.png": __vite_glob_0_20, "./icon/29.png": __vite_glob_0_21, "./icon/3.png": __vite_glob_0_22, "./icon/30.png": __vite_glob_0_23, "./icon/31.png": __vite_glob_0_24, "./icon/32.png": __vite_glob_0_25, "./icon/33.png": __vite_glob_0_26, "./icon/34.png": __vite_glob_0_27, "./icon/35.png": __vite_glob_0_28, "./icon/4.png": __vite_glob_0_29, "./icon/5.png": __vite_glob_0_30, "./icon/6.png": __vite_glob_0_31, "./icon/7.png": __vite_glob_0_32, "./icon/8.png": __vite_glob_0_33, "./icon/9.png": __vite_glob_0_34 }))[`./icon/${k}`], import.meta.url).href, b = (k, i) => {
      console.log(k), console.log(l.currentItem), l.currentItem[i] = l.currentItem[i] ? 1 : 0;
    }, K = ref([
      "#ff4500",
      "#ff8c00",
      "#ffd700",
    ...
    return y.http.post("api/Sys_Dictionary/GetVueDictionary", ["dbServer"]).then((k) => {
      ...
      const q = resolveComponent("el-scrollbar"), D = resolveComponent("el-button"), M = resolveComponent("el-dialog"), Y = resolveComponent("Setting"), w = resolveComponent("el-icon"), f = resolveComponent("el-input"), E = resolveComponent("el-descriptions-item"), d = resolveComponent("el-descriptions"), u = resolveComponent("el-option"), m = resolveComponent("el-select"), p = resolveComponent("el-input-number"), F = resolveComponent("el-tab-pane"), L = resolveComponent("Monitor"), N = resolveComponent("FolderOpened"), R = resolveComponent("el-color-picker"), U = resolveComponent("Plus"), W = resolveComponent("Sort"), G = resolveComponent("el-tabs");
      return openBlock(), createElementBlock(Fragment, null, [
        createVNode(M, {
          modelValue: Q.value,
          "onUpdate:modelValue": i[1] || (i[1] = (o) => Q.value = o),
        ...
        createVNode(G, {
          modelValue: a.value,
          "onUpdate:modelValue": i[43] || (i[43] = (o) => a.value = o),
          class: "demo-tabs"
        }, {
          default: withCtx(() => [
            createVNode(F, { name: "基础设置" }, {
              ...
              default: withCtx(() => [
                createElementVNode("div", _hoisted_13$1, [
                  ...
                  e.currentItem.showFilter ? (openBlock(), createBlock(d, {
                    key: 0,
                    class: "desc-top",
                    column: 1,
                    size: "default",
                        ...
                        createVNode(E, {
                          ...
                          default: withCtx(() => [
                            createVNode(p, {
                              ...
                              "onUpdate:modelValue": i[12] || (i[12] = (o) => e.currentItem.column = o)
                            }, null, 8, ["modelValue"])
                          ]),
                          _: 1
                        })
                        ...
                        createVNode(E, {
                          ...
                          default: withCtx(() => [
                            createVNode(f, {
                              ...
                              "onUpdate:modelValue": i[13] || (i[13] = (o) => e.currentItem.formText = o)
                            }, null, 8, ["modelValue"])
                          ]),
                          _: 1
                        })
                      ...
                      createVNode(E, {
                        ...
                        default: withCtx(() => [
                          createVNode(f, {
                            ...
                            "onUpdate:modelValue": i[14] || (i[14] = (o) => e.currentItem.dataText = o)
                          }, null, 8, ["modelValue"])
                        ]),
                        _: 1
                      })
            ...
            createVNode(F, { name: "属性设置" }, {
              ...
              default: withCtx(() => [
                e.currentItem.icon && e.currentItem.type == "gridText" || e.currentItem.type == "ranking" ? (openBlock(), createElementBlock("div", _hoisted_18$1, [
                  e.currentItem.type == "gridText" ? (openBlock(), createBlock(d, {
                    key: 0,
                    class: "desc-top",
                    column: 1,
                    size: "default",
                          ...
                          createElementVNode("div", _hoisted_22$1, [
                            (openBlock(!0), createElementBlock(Fragment, null, renderList(e.currentItem.bgColor, (o, I) => (openBlock(), createElementBlock("div", {
                              ...
                              createVNode(R, {
                                ...
                                "onUpdate:modelValue": (V) => e.currentItem.bgColor[I] = V
                              }, null, 8, ["predefine", "modelValue", "onUpdate:modelValue"]),
                              createElementVNode("span", {
                                class: "color-item-del el-icon-delete",
                                onClick: (V) => e.currentItem.bgColor.splice(I, 1)
                              }, null, 8, _hoisted_23)
                            ]))), 128)),
                            createVNode(w, {
                              onClick: i[16] || (i[16] = (o) => e.currentItem.bgColor.push("")),
                              size: "20",
                              color: "#928f8f",
                              style: { position: "relative", top: "3px" }
                            }, {
                          ...
                          createElementVNode("div", _hoisted_24, [
                            (openBlock(!0), createElementBlock(Fragment, null, renderList(e.currentItem.titleColor, (o, I) => (openBlock(), createElementBlock("div", {
                              ...
                              createVNode(R, {
                                ...
                                "onUpdate:modelValue": (V) => e.currentItem.titleColor[I] = V
                              }, null, 8, ["predefine", "modelValue", "onUpdate:modelValue"]),
                              createElementVNode("span", {
                                class: "color-item-del el-icon-delete",
                                onClick: (V) => e.currentItem.titleColor.splice(I, 1)
                              }, null, 8, _hoisted_25)
                            ]))), 128)),
                            createVNode(w, {
                              onClick: i[17] || (i[17] = (o) => e.currentItem.titleColor.push("")),
                              size: "20",
                              color: "#928f8f",
                              style: { position: "relative", top: "3px" }
                            }, {
                          ...
                          createElementVNode("div", _hoisted_26, [
                            (openBlock(!0), createElementBlock(Fragment, null, renderList(e.currentItem.fontColor, (o, I) => (openBlock(), createElementBlock("div", {
                              ...
                              createVNode(R, {
                                ...
                                "onUpdate:modelValue": (V) => e.currentItem.fontColor[I] = V
                              }, null, 8, ["predefine", "modelValue", "onUpdate:modelValue"]),
                              createElementVNode("span", {
                                class: "color-item-del el-icon-delete",
                                onClick: (V) => e.currentItem.fontColor.splice(I, 1)
                              }, null, 8, _hoisted_27)
                            ]))), 128)),
                            createVNode(w, {
                              onClick: i[18] || (i[18] = (o) => e.currentItem.fontColor.push("")),
                              size: "20",
                              color: "#928f8f",
                              style: { position: "relative", top: "3px" }
                            }, {
                      ...
                      createVNode(E, {
                        ...
                        default: withCtx(() => [
                          createVNode(m, {
                            ...
                            "onUpdate:modelValue": i[19] || (i[19] = (o) => e.currentItem.showNumber = o),
                            onChange: c
                          }, {
                            default: withCtx(() => [
                              createVNode(u, {
                  ...
                  e.currentItem.type == "ranking" ? (openBlock(), createElementBlock(Fragment, { key: 2 }, [
                    createVNode(d, {
                      class: "desc-top",
                      column: 1,
                      size: "default",
                        ...
                        createVNode(E, {
                          ...
                          default: withCtx(() => [
                            createVNode(p, {
                              ...
                              "onUpdate:modelValue": i[20] || (i[20] = (o) => e.currentItem.strokeWidth = o),
                              onChange: c
                            }, null, 8, ["modelValue"])
                          ]),
                          _: 1
                        ...
                        createVNode(E, {
                          ...
                          default: withCtx(() => [
                            createVNode(f, {
                              ...
                              "onUpdate:modelValue": i[21] || (i[21] = (o) => e.currentItem.unit = o),
                              onBlur: c
                            }, null, 8, ["modelValue"])
                          ]),
                          _: 1
                      ...
                      createVNode(E, {
                        ...
                        default: withCtx(() => [
                          createVNode(p, {
                            ...
                            "onUpdate:modelValue": i[22] || (i[22] = (o) => e.currentItem.imgSize = o),
                            onChange: c
                          }, null, 8, ["modelValue"])
                        ]),
                        _: 1
                      ...
                      createVNode(E, {
                        ...
                        default: withCtx(() => [
                          createVNode(p, {
                            ...
                            "onUpdate:modelValue": i[23] || (i[23] = (o) => e.currentItem.grid.left = o),
                            placeholder: "图间距(左)",
                            step: 5
                          }, null, 8, ["modelValue"])
                        ]),
                      ...
                      createVNode(E, {
                        ...
                        default: withCtx(() => [
                          createVNode(p, {
                            ...
                            "onUpdate:modelValue": i[24] || (i[24] = (o) => e.currentItem.grid.top = o),
                            placeholder: "图间距(上)",
                            step: 5
                          }, null, 8, ["modelValue"])
                        ]),
                      ...
                      createVNode(E, {
                        ...
                        default: withCtx(() => [
                          createVNode(p, {
                            ...
                            "onUpdate:modelValue": i[25] || (i[25] = (o) => e.currentItem.grid.right = o),
                            placeholder: "图间距(右)",
                            step: 5
                          }, null, 8, ["modelValue"])
                        ]),
                      ...
                      createVNode(E, {
                        ...
                        default: withCtx(() => [
                          createVNode(p, {
                            ...
                            "onUpdate:modelValue": i[26] || (i[26] = (o) => e.currentItem.grid.bottom = o),
                            placeholder: "图间距(下)",
                            step: 5
                          }, null, 8, ["modelValue"])
                        ]),
                      ...
                      createVNode(E, {
                        ...
                        default: withCtx(() => [
                          createVNode(p, {
                            ...
                            "onUpdate:modelValue": i[27] || (i[27] = (o) => e.currentItem.left = o),
                            placeholder: "图间距左右",
                            step: 5
                          }, null, 8, ["modelValue"])
                        ]),
                      ...
                      createVNode(E, {
                        ...
                        default: withCtx(() => [
                          createVNode(p, {
                            ...
                            "onUpdate:modelValue": i[28] || (i[28] = (o) => e.currentItem.top = o),
                            placeholder: "图间距上下",
                            step: 5
                          }, null, 8, ["modelValue"])
                        ]),
                      ...
                      createVNode(E, {
                        ...
                        default: withCtx(() => [
                          createVNode(p, {
                            ...
                            "onUpdate:modelValue": i[29] || (i[29] = (o) => e.currentItem.size1 = o),
                            placeholder: "饼图大小内",
                            step: 5
                          }, null, 8, ["modelValue"])
                        ]),
                      ...
                      createVNode(E, {
                        ...
                        default: withCtx(() => [
                          createVNode(p, {
                            ...
                            "onUpdate:modelValue": i[30] || (i[30] = (o) => e.currentItem.size2 = o),
                            placeholder: "饼图大小外",
                            step: 5
                          }, null, 8, ["modelValue"])
                        ]),
                ...
                withDirectives(createElementVNode("div", _hoisted_31, [
                  withDirectives(createVNode(d, {
                      ...
                      createVNode(E, {
                        ...
                        default: withCtx(() => [
                          createVNode(m, {
                            ...
                            "onUpdate:modelValue": i[31] || (i[31] = (o) => e.currentItem.legend = o)
                          }, {
                            default: withCtx(() => [
                              (openBlock(), createElementBlock(Fragment, null, renderList(g, (o, I) => createVNode(u, {
                                key: I,
                                value: o.value,
                                label: o.name
                    ...
                    [vShow, e.currentItem.type == "bar" || e.currentItem.type == "line" || e.currentItem.type == "pie"]
                  ]),
                  createVNode(d, {
                    class: "desc-top",
                    column: 1,
                      ...
                      createVNode(E, {
                        ...
                        default: withCtx(() => [
                          createVNode(m, {
                            ...
                            "onUpdate:modelValue": i[32] || (i[32] = (o) => e.currentItem.legendShape = o)
                          }, {
                            default: withCtx(() => [
                              (openBlock(), createElementBlock(Fragment, null, renderList(s, (o, I) => createVNode(u, {
                                key: I,
                                value: o.value,
                                label: o.name
                              }, null, 8, ["value", "label"])), 64))
                      ...
                      createVNode(E, {
                        ...
                        default: withCtx(() => [
                          createVNode(p, {
                            ...
                            "onUpdate:modelValue": i[33] || (i[33] = (o) => e.currentItem.legendSize = o),
                            placeholder: "图例大小"
                          }, null, 8, ["modelValue"])
                        ]),
                        _: 1
                      ...
                      createVNode(E, {
                        ...
                        default: withCtx(() => [
                          createVNode(p, {
                            ...
                            "onUpdate:modelValue": i[34] || (i[34] = (o) => e.currentItem.radius = o),
                            step: 2,
                            placeholder: "圆角"
                          }, null, 8, ["modelValue"])
                        ]),
                  ...
                  e.currentItem.type == "bar" ? (openBlock(), createBlock(d, {
                    key: 0,
                    class: "desc-top",
                    column: 1,
                    size: "default",
                      ...
                      createVNode(E, {
                        ...
                        default: withCtx(() => [
                          createVNode(p, {
                            ...
                            "onUpdate:modelValue": i[35] || (i[35] = (o) => e.currentItem.barMaxWidth = o),
                            step: 2,
                            placeholder: "宽度"
                          }, null, 8, ["modelValue"])
                        ]),
                      ...
                      createVNode(E, {
                        ...
                        default: withCtx(() => [
                          createVNode(m, {
                            ...
                            "onUpdate:modelValue": i[36] || (i[36] = (o) => e.currentItem.xLine = o),
                            onChange: c
                          }, {
                            default: withCtx(() => [
                              createVNode(u, {
                      ...
                      createVNode(E, {
                        ...
                        default: withCtx(() => [
                          createVNode(m, {
                            ...
                            "onUpdate:modelValue": i[37] || (i[37] = (o) => e.currentItem.yLine = o),
                            onChange: c
                          }, {
                            default: withCtx(() => [
                              createVNode(u, {
                      ...
                      createVNode(E, {
                        ...
                        default: withCtx(() => [
                          createVNode(m, {
                            ...
                            "onUpdate:modelValue": i[38] || (i[38] = (o) => e.currentItem.showLabel = o),
                            onChange: c
                          }, {
                            default: withCtx(() => [
                              createVNode(u, {
                      ...
                      createVNode(E, {
                        ...
                        default: withCtx(() => [
                          createVNode(m, {
                            ...
                            "onUpdate:modelValue": i[39] || (i[39] = (o) => e.currentItem.stack = o),
                            onChange: c
                          }, {
                            default: withCtx(() => [
                              createVNode(u, {
                      ...
                      createVNode(E, {
                        ...
                        default: withCtx(() => [
                          createVNode(m, {
                            ...
                            "onUpdate:modelValue": i[40] || (i[40] = (o) => e.currentItem.showXData = o),
                            onChange: c
                          }, {
                            default: withCtx(() => [
                              createVNode(u, {
                    ...
                    createVNode(E, {
                      ...
                      default: withCtx(() => [
                        createVNode(f, {
                          ...
                          "onUpdate:modelValue": i[41] || (i[41] = (o) => e.currentItem.openUrl = o)
                        }, null, 8, ["modelValue"])
                      ]),
                      _: 1
                    })
                    ...
                    createVNode(E, {
                      ...
                      default: withCtx(() => [
                        createVNode(f, {
                          ...
                          "onUpdate:modelValue": i[42] || (i[42] = (o) => e.currentItem.eventClick = o),
...
}, VolDataParams = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-34e8ff3f"]]), _hoisted_1$2 = ["onClick"], _sfc_main$2 = {
  ...
  setup(e, { emit: A }) {
    ...
    return watch(
      ...
      const r = resolveComponent("arrow-down"), C = resolveComponent("el-icon"), c = resolveComponent("el-button"), Q = resolveComponent("el-dropdown-item"), v = resolveComponent("el-dropdown-menu"), h = resolveComponent("el-dropdown");
      return e.filterType == "纵向显示" ? (openBlock(), createBlock(h, { key: 0 }, {
        dropdown: withCtx(() => [
          createVNode(v, null, {
            default: withCtx(() => [
              (openBlock(!0), createElementBlock(Fragment, null, renderList(unref(filter), (S, J) => (openBlock(), createBlock(Q, {
                ...
                default: withCtx(() => [
                  createElementVNode("div", {
                    ...
                    onClick: (b) => g(S)
                  }, toDisplayString(S), 9, _hoisted_1$2)
                ]),
                _: 2
              }, 1024))), 128))
            ]),
        ...
        (openBlock(!0), createElementBlock(Fragment, null, renderList(unref(filter), (S, J) => (openBlock(), createBlock(c, {
          onClick: (b) => s(S),
          plain: S != a.value,
          size: "small",
          type: S === a.value ? "primary" : "",
          key: J
        }, {
          default: withCtx(() => [
  ...
  setup(e, { emit: A }) {
    getCurrentInstance();
    const l = e, a = computed(() => l.data.length ? Object.keys(l.data[0]).filter((s) => s != "id") : []), n = A, g = (s) => {
      n("componentItemClick", s, l.data);
    };
    return (s, t) => {
      const B = resolveComponent("ArrowRight"), r = resolveComponent("el-icon"), C = resolveComponent("el-scrollbar");
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        createVNode(VolTitle, {
          icon: "el-icon-menu",
          title: s.$ts(e.title)
        }, null, 8, ["title"]),
        createVNode(C, { style: { flex: "1", height: "0", padding: "0 10px 10px 10px" } }, {
          default: withCtx(() => [
            createElementVNode("table", _hoisted_2$1, [
              (openBlock(!0), createElementBlock(Fragment, null, renderList(e.data, (c, Q) => (openBlock(), createElementBlock("tr", {
                onClick: withModifiers((v) => g(c), ["stop"]),
                key: Q
              }, [
                (openBlock(!0), createElementBlock(Fragment, null, renderList(a.value, (v, h) => (openBlock(), createElementBlock("td", { key: h }, [
...
}, VolDataNotice = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-15b40fbf"]]), _withScopeId = (e) => (pushScopeId("data-v-2f1e44de"), e = e(), popScopeId(), e), _hoisted_1 = { class: "grid-box" }, _hoisted_2 = {
  key: 0,
  ...
  _hoisted_8
], _hoisted_10 = ["onClick"], _hoisted_11 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createElementVNode("i", { class: "el-icon-receiving" }, null, -1)), _hoisted_12 = { class: "txt" }, _hoisted_13 = ["onClick"], _hoisted_14 = { class: "vol-grid-item-title" }, _hoisted_15 = { class: "vol-grid-item-value" }, _hoisted_16 = { class: "vol-grid-item-unit" }, _hoisted_17 = ["id"], _hoisted_18 = { class: "vol-grid-item-bottom" }, _hoisted_19 = ["onClick"], _hoisted_20 = ["id"], _hoisted_21 = {
  key: 1,
  class: "icon-toggle"
}, _hoisted_22 = { class: "grid-form-content" }, __default__ = {
  name: "VolDashboard"
  ...
  props: {
    id: {
      ...
      default: "f7cce37d-f0d9-428c-a1ed-494bc12419cf"
  ...
  setup(__props, { emit: __emit }) {
    ...
    const layout = ref([
      ...
      if (e.type == "pie" && (A.legend = "rightVerticalCenter"), A.title = e.title, A.w = e.w || A.w, A.h = e.h || A.h, A.icon = (e.icon || []).map((l) => l), Object.assign(A, e), ["table", "form", "card"].includes(e.type) ? e.type == "form" || e.type == "card" ? (A.form = e.form(e.type == "card"), A.data = e.data(e.type == "card")) : A.data = e.data() : (["step", "gridText"].includes(e.type) || e.data && typeof e.data == "function") && (A.data = e.data()), layout.value.length) {
        let l = layout.value.reduce((n, g) => Math.max(n, g.x), layout.value[0].x), a = layout.value.reduce((n, g) => Math.max(n, g.y), layout.value[0].y);
        A.x = l + 1, A.y = a + 1;
      }
      ...
      e.type == "pie" ? a = pie.init(e, e.data) : e.type == "gauge" ? a = gauge.init(e, e.data) : e.type == "gridLine" || e.type == "gridBar" ? (a = options.gridLine(), e.data && (a.series[0].data = e.data.data || []), e.type == "gridBar" && (a.series[0].type = "bar")) : ["line", "bar"].includes(e.type) && (a = BarLineChartOptionn.init(e, e.data), a.series.forEach((g) => {
        g.type = e.type;
      }));
      let n = filterData(e, a);
      n && (a = n), l.setOption(a, !!A), e.$chart = l;
      ...
      try {
        if (console.log("paramsChange"), e === 1) {
          ...
          if (currentItem.value.sql) {
            ...
            getApiUrlItemData(props.id || layout.value.dashboardId, currentItem.value, A);
          }
          return;
        }
        if (
      ...
      if (!e.type && A.value && (e.type = A.value.type), !e.url)
        return;
      let a = e.url + (e.url.indexOf("?") != -1 ? "&" : "?") + "id=" + props.id + "&itemId=" + (e.i + "") + "&date1=null&date2=null&filterType=" + e.filterValue;
    ...
    const getData = (e) => {
      ...
      proxy.http.post(A, {}, !0).then((l) => {
        ...
        layout.value = a, a.forEach((n, g) => {
          n.data = getDefaultData(n), n.dataText = JSON.stringify(n.data), n.sql || n.url ? (typeof n.data == "function" && (n.data = n.data()), Array.isArray(n.data) ? n.data = [] : n.data = {}, n.isLoad = !isChart(n)) : n.isLoad = !0, n.url ? loadItemData(layout.value[g], l) : n.sql && (A = "api/Sys_Dashboard/getItemData?id=" + l.dashboardId + "&itemId=" + (n.i + "") + "&date1=null&date2=null&filterType=" + n.filterValue, getApiUrlItemData(l.dashboardId, layout.value[g], A));
    ...
    const getDefaultData = (e) => {
      ...
      let e = layout.value.map((a) => {
        ...
        return Object.keys(a).forEach((g) => {
          g != "$chart" && g != "dataText" && g != "data" && (n[g] = a[g]), g == "type" && (n.data = getDefaultData(a));
        }), n;
      }), A = {
        mainData: {
    ...
    return (e, A) => {
      const l = resolveComponent("el-scrollbar"), a = resolveComponent("el-button"), n = resolveComponent("el-calendar"), g = resolveComponent("grid-item"), s = resolveComponent("grid-layout");
      return openBlock(), createElementBlock("div", _hoisted_1, [
            ...
            default: withCtx(() => [
              createElementVNode("div", {
                ...
                createVNode(s, {
                  ...
                  default: withCtx(() => [
                    (openBlock(!0), createElementBlock(Fragment, null, renderList(layout.value, (t, B) => (openBlock(), createBlock(g, {
                      ...
                      default: withCtx(() => [
                        ...
                        t.showFilter ? (openBlock(), createElementBlock("div", {
                          ...
                          createVNode(VolDataFilter, {
                            ...
                            "onUpdate:modelValue": (r) => t.filterValue = r,
                            onFilterChange: () => {
                              filterChange(t);
                            }
                        ...
                        t.type == "table" ? (openBlock(), createBlock(VolDataTable, {
                          ...
                          title: t.title,
                          data: t.data,
                          onComponentItemClick: (r, C) => {
                            componentItemClick(r, C, t);
                          }
                          ...
                          "date-cell": withCtx(({ data: r }) => [
                            createElementVNode("div", {
                              class: normalizeClass([r.isSelected || dtNow == r.day ? "is-selected" : "", "date-cell"])
                            }, toDisplayString(r.day.split("-").slice(1)[1]), 3)
                          ]),
                          _: 2
                          ...
                          (openBlock(!0), createElementBlock(Fragment, null, renderList(t.data, (r, C) => (openBlock(), createBlock(VolDataGridText, {
                            style: { flex: "1" },
                            key: C,
                            data: [r],
                            font: t.isFont,
                            showNumber: !!t.showNumber,
                            "font-color": t.fontColor[C],
                            "bg-color": t.bgColor[C],
                            "title-color": t.titleColor[C],
                            icon: [
                              t.icon[C] || (t.isFont ? "el-icon-receiving" : "32.png")
                            ],
                            onClick: (c) => itemClick(t),
                            onComponentItemClick: (c, Q) => {
                              componentItemClick(c, Q, t);
                            },
                            size: t.imgSize
                          ...
                          t.isLoad ? (openBlock(), createElementBlock("div", {
                            ...
                            ref_for: !0,
                            ref: (r) => setItemRef(r, t),
                            id: t.i
                          }, null, 8, _hoisted_17)) : createCommentVNode("", !0),
                          createElementVNode("div", _hoisted_18, [
                            (openBlock(!0), createElementBlock(Fragment, null, renderList(t.data.bottom || [], (r, C) => (openBlock(), createElementBlock("div", { key: C }, toDisplayString(r), 1))), 128))
                          ])
                          ...
                          t.isLoad ? (openBlock(), createElementBlock("div", {
                            ...
                            ref: (r) => setItemRef(r, t),
                            id: t.i
                          }, null, 8, _hoisted_20)) : createCommentVNode("", !0)
                        ], 8, _hoisted_19))
                      ]),
                      _: 2
        ...
        __props.readonly ? createCommentVNode("", !0) : (openBlock(), createElementBlock("div", _hoisted_21, [
          createElementVNode("i", {
...
}), VolDashboard = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2f1e44de"]]);
